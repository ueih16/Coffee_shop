    ...
    <div class="main-content">
        <div class="flex">
            ...
            <div class="w-full flex flex-col justify-center items-center px-24 sm-max:px-10 py-24">
                <p class="text-2xl uppercase font-semibold font-karla tracking-widest text-gray-400 text-center">Confirm Password</p>

                <div class="w-[60%] sm-max:w-full mt-6">
                    <form method="post" action="{{ route('employee.confirming.password') }}">
                        @csrf
