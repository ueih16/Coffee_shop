            ...
            <div class="content-wrapper max-w-screen-xl text-base mx-auto px-8">
                ...
                <header class="p-6 mx-auto">
                    <nav class="flex flex-row justify-between items-center relative">
                        ...
                        <!-- End logo -->
                        <ul id="ct-top-menu" class="basis-3/6 hidden lg:flex lg:justify-end lg:items-center lg:gap-8 uppercase text-sm text-gray-500 font-medium">
                        ...
                        <!-- End list products -->
                        <ul class="basis-3/6 lg:basis-1/6 flex justify-end lg:justify-start items-center ml-16 uppercase text-sm text-gray-500 font-medium">
                            <li class="">
                ...
                <main>
                    <!-- Start slider -->
                    <div class="slider h-[530px] bg-[url('../assets/images/slide-picture.jpg')] bg-cover bg-no-repeat bg-bottom">
                        <div class="w-full h-full flex justify-center items-center bg-gray-900 bg-opacity-40">
                            <div class="mx-16 text-white text-center">
                                <div class="uppercase text-xs my-3 font-semibold tracking-widest">Best to buy Coffee</div>
                                <div class="font-medium text-5xl mb-5">Coffee Mugs</div>
                                <div class="text-lg mb-6">The most versatile furniture system ever created. Designed to fit your life, made to move and grow.</div>
                                <div class="flex justify-center">
                                    <div class="uppercase bg-white text-gray-900 w-max px-8 py-4 text-sm font-semibold tracking-widest cursor-pointer hover:bg-opacity-95">
